...
function placeXOrO(squareNumber) {
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        if (activePlayer === 'X') {
            //If activePlayer is equal to 'X', the x.png is placed in HTML select.style.backgroundImage
...
function checkWinConditions() {
    ...
    else if (arrayIncludes('OX', '4X', '8X')) { drawWinLine(100, 100, 520, 520) } // 0 0, 1, 2 condition.
    else if (arrayIncludes('00', '10', '20')) { drawWinLine(50, 100, 558, 100) } // 0 3, 4, 5 condition.
    else if (arrayIncludes('30', '40', '50')) { drawWinLine(50, 304, 558, 304) } // 0 6, 7, 8 condition.
    else if (arrayIncludes('60', '70', '80')) { drawWinLine(50, 508, 558, 508) } // 0 0, 3, 6 condition.
    else if (arrayIncludes('00', '30', '60')) { drawWinLine(100, 50, 100, 558) } // 0 1, 4, 7 condition.
    else if (arrayIncludes('10', '40', '70')) { drawWinLine(304, 50, 304, 558) }
    else if (arrayIncludes('20', '50', '80')) { drawWinLine(508, 50, 508, 558) } // 0 6, 4, 2 condition.
    else if (arrayIncludes('60', '40', '20')) { drawWinLine(100, 508, 510, 90) } // 0 0, 4, 8 condition.
